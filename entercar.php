    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
            <input type="text" class="form-control" id="auto_price" name="auto_price" placeholder="Auto Fare per KM (Rm)" required>
          </div>

          <div class="form-group">
            <input type="text" class="form-control" id="manual_price" name="manual_price" placeholder="Manual Fare per KM (Rm)" required>
          </div>

          <div class="form-group">
            <input type="text" class="form-control" id="auto_price_per_day" name="auto_price_per_day" placeholder="Auto Fare per day (Rm)" required>
          </div>

          <div class="form-group">
            <input type="text" class="form-control" id="manual_price_per_day" name="manual_price_per_day" placeholder="Manual Fare per day (Rm)" required>
          </div>
